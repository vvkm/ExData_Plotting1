...
plot(household200702$Timestamp, household200702$Voltage, xlab="datetime", ylab="Voltage", type='l')
...
plot(household200702$Timestamp, household200702$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type='l')
